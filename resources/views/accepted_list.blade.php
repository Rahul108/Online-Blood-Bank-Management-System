                        ...
                        <a href="{{ route('show_history') }}" class="btn btn-success" style="text-align:center;font-size:18px;padding-top:30px;padding-bottom:30px;padding-left:102px;padding-right:102px">History</a>  </li></p>
                          ...
                          <div class="col-sm-9">
                            <div class="row">
                              ...
                              @foreach($data_acpt as $a)
                              <div class="col-sm-12">
                                <div class="card-body">

                                    @foreach($data_user as $u)
                                      @if($a->mobile_no == $u->mobile_no)
                                        <img src="/uploads/avatars/{{ $u->avatar }}" style="width:30px;height:30px;top:10px;left:10px;border-radius:50%;float:left;align:left;margin-right:10px;" >
                                        {{ $u->name }}
                                      @endif
                                    @endforeach
